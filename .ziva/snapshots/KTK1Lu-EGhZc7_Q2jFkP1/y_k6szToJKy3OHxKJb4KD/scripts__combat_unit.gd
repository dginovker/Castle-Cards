...
@export var health_bar_bg_color: Color = Color(0.08, 0.08, 0.08, 0.85)
@export var health_bar_fill_color: Color = Color(0.2, 0.9, 0.25, 0.95)
@export var health_bar_border_color: Color = Color(0.0, 0.0, 0.0, 1.0)
@export_range(8.0, 80.0, 1.0) var health_bar_width_pixels: float = 26.0
@export_range(2.0, 16.0, 1.0) var health_bar_height_pixels: float = 4.0
@export_range(0.0, 40.0, 1.0) var health_bar_vertical_offset_pixels: float = 10.0
...
func _draw() -> void:
    if show_health_bar and max_health > 0.0:
